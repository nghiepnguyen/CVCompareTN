      ...
      {authModalMode && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-md bg-primary-light/95 backdrop-blur-2xl border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden"
          >
            {/* Tab Switcher */}
            <div className="flex relative bg-white/[0.02] p-1 m-4 rounded-xl">
              <button
                type="button"
                onClick={() => switchMode('signIn')}
                className={cn(
                  'relative flex-1 px-4 py-2.5 rounded-lg text-sm font-bold transition-colors z-10 cursor-pointer hover:scale-105 active:scale-95',
                  mode === 'signIn' ? 'text-white' : 'text-text-muted hover:text-text-main',
                )}
              >
              ...
              <button
                ...
                className={cn(
                  'relative flex-1 px-4 py-2.5 rounded-lg text-sm font-bold transition-colors z-10 cursor-pointer hover:scale-105 active:scale-95',
                  mode === 'signUp' ? 'text-white' : 'text-text-muted hover:text-text-main',
                )}
              >
              ...
              {successMessage ? (
                ...
                <>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            autoComplete="name"
                            className={cn(
                              'w-full pl-10 pr-4 py-3 bg-white/[0.03] border rounded-xl text-sm font-bold text-text-main placeholder:text-text-light/50 outline-none transition-all',
                              fieldErrors.name
                                ? 'border-error/50 focus:border-error focus:ring-2 focus:ring-error/20'
                                : 'border-white/[0.08] focus:border-accent/50 focus:ring-2 focus:ring-accent/20',
                            )}
                          />
                        </div>
                        {fieldErrors.name && (
                      ...
                      <div className="mb-4">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={cn(
                              'w-full pl-10 pr-12 py-3 bg-white/[0.03] border rounded-xl text-sm font-bold text-text-main placeholder:text-text-light/50 outline-none transition-all',
                          ...
                          <button
                            ...
                            className="absolute right-3.5 top-1/2 -translate-y-1/2 text-text-light hover:text-text-muted transition-colors cursor-pointer p-1 rounded-lg hover:bg-white/[0.04]"
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 bg-white/[0.03] border border-white/[0.08] rounded-xl text-sm font-bold text-text-main hover:bg-white/[0.06] hover:border-white/[0.12] transition-all cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
                  >
