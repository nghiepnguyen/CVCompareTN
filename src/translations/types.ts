...
export interface UiLabels {
  ...
  adminReportAnalysesThisMonthTooltip: string;
  ...
  adminReportColCountTooltip: string;
  ...
  privacyS6Title: string;
  privacyS6Intro: string;
  privacyS6Scope1: string;
  privacyS6Scope2: string;
  privacyS6Scope3: string;
  privacyS6Note: string;
  privacyS6LimitedUse: string;
  privacyS7Title: string;
  privacyS7Intro: string;
  privacyS7Item1: string;
  privacyS7Item2: string;
  privacyS7Item3: string;
  privacyS7Item4: string;
  privacyS7Item5: string;
  privacyS7Note: string;
  privacyS8Title: string;
  privacyS8Item1: string;
  privacyS8Item2: string;
  privacyS8Item3: string;
  privacyS8Item4: string;
  privacyS8Delete: string;
  privacyS9Title: string;
  privacyS9Body: string;
  privacyS10Title: string;
  privacyS10Body: string;
  privacyS11Title: string;
  privacyS11Body: string;
  privacyS12Title: string;
  privacyS12Body: string;
  problemItem1: string;
  problemItem2: string;
  problemItem3: string;
  problemItem4: string;
