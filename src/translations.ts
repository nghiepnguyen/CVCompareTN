export const UI_LABELS = {
  vi: {
    ...
    fullCvDraftFooter: "cv.thanhnghiep.top · Bản nháp do CV Matcher & Optimizer tạo ra.",
    fullCvSpecimenEyebrow: "Mẫu · CV hoàn chỉnh",
    copy: "Sao chép",
    copied: "Đã sao chép",
    download: "Tải xuống",
    original: "Gốc",
    ...
    jdDesc: 'Cung cấp thông tin về vị trí tuyển dụng',
    textMode: 'VĂN BẢN',
    linkMode: 'LINK',
    jdStore: 'Kho JD',
    saveJd: 'Lưu JD',
  ...
  en: {
    ...
    fullCvDraftFooter: "cv.thanhnghiep.top · Draft produced by CV Matcher & Optimizer.",
    fullCvSpecimenEyebrow: "Specimen · full CV",
    copy: "Copy",
    copied: "Copied",
    download: "Download",
    original: "Original",
    ...
    jdDesc: 'Provide information about the job position',
    textMode: 'TEXT',
    linkMode: 'LINK',
    jdStore: 'JD Store',
    saveJd: 'Save JD',
