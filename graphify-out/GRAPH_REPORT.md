# Graph Report - cv-compare-tn  (2026-05-29)

## Corpus Check
- 155 files · ~69,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 506 nodes · 778 edges · 31 communities (27 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f04ef312`
...
- `AnalysisRunProvider()` --calls--> `useAuth()`  [EXTRACTED]
  src/context/analysis/AnalysisRunContext.tsx → AuthContext.tsx
- `AnalysisRunProvider()` --calls--> `useUI()`  [EXTRACTED]
  src/context/analysis/AnalysisRunContext.tsx → context/UIContext.tsx
...
Cohesion: 0.07
Nodes (39): SavedJdContext, SavedJdProvider(), useSavedJds(), AppContent(), useAuth(), Tab, UIContext, UIContextType (+31 more)
...
Cohesion: 0.09
Nodes (24): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), cleanText(), ProcessedFile, processFile(), result, createProgressSimulator() (+16 more)
...
Cohesion: 0.19
Nodes (9): analyzeCV(), parseGeminiJson(), ensureApiKey(), getGeminiClient(), loadKeyFromConfig(), buildAnalyzePromptEn(), buildAnalyzePromptVi(), PromptParams (+1 more)
...
## Knowledge Gaps
- **195 isolated node(s):** `Entry & shell (`src/app/`)`, `Global state (`src/context/`)`, `Custom hooks (`src/hooks/`)`, `Test suite (`src/__tests__/`)`, `Views (`src/components/views/`)` (+190 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 3`, `Community 5`, `Community 14`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 3`, `Community 5`, `Community 14`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `formatLabel()` connect `Community 0` to `Community 13`, `Community 3`, `Community 5`?**
