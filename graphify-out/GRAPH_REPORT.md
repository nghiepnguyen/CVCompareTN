...
## Corpus Check
- 167 files · ~79,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 858 nodes · 1639 edges · 43 communities (39 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c933aec7`
...
- `useAnalysis()` --calls--> `useSavedCvs()`  [EXTRACTED]
  src/context/analysis/AnalysisProvider.tsx → SavedCvContext.tsx

## Communities (43 total, 4 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (71): useAnalysis(), SavedCvProvider(), SavedJdProvider(), AppContent(), MobileBottomNav(), MobileBottomNavProps, PrivacyPolicyPage(), TermsOfServicePage() (+63 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (56): activateProForOrder(), fetchProfileForEmail(), handlePaymentConfirm(), handlePaymentCreate(), handlePaymentWebhook(), isWebhookPaymentSuccess(), normalizeOrderCode(), notifyVipUpgrade() (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (39): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), SavedCvContext, useSavedCvs(), SavedJdContext, useSavedJds(), AnalysisContextType (+31 more)
...
Cohesion: 0.11
Nodes (27): SupabaseConfigError(), AuthContext, AuthContextType, AuthProvider(), bootstrapSupabase(), createSupabaseClient(), getDefaultMonthlyAnalyticsLimit(), parseLimitValue() (+19 more)
...
Cohesion: 0.11
Nodes (12): admin, billing, footer, history, LocaleEntry, SECTIONS, input, landing (+4 more)
...
## Knowledge Gaps
- **267 isolated node(s):** `PaymentHandlerResult`, `VipUpgradeEmailParams`, `SavedCvContext`, `Sửa khi push GitHub deploy nhầm project`, `Các bước thực hiện:` (+262 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 9`, `Community 2`, `Community 11`, `Community 6`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 9`, `Community 2`, `Community 11`, `Community 6`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 0` to `Community 9`, `Community 11`, `Community 6`, `Community 17`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `PaymentHandlerResult`, `VipUpgradeEmailParams`, `SavedCvContext` to the rest of the system?**
