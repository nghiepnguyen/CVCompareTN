...
## Corpus Check
- 185 files · ~104,855 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1037 nodes · 2002 edges · 54 communities (49 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6d69988`
...
6. `LandingLabels` - 15 edges
7. `handlePaymentConfirm()` - 14 edges
8. `Hạn mức phân tích CV/tháng (Supabase — không phải GA4)` - 14 edges
9. `handlePaymentWebhook()` - 13 edges
10. `handlePaymentCreate()` - 12 edges
...
- `SavedCvProvider()` --calls--> `useAuth()`  [EXTRACTED]
  SavedCvContext.tsx → src/context/AuthContext.tsx

## Communities (54 total, 5 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (80): useAnalysis(), AnalysisRunProvider(), SavedCvProvider(), useSavedCvs(), SavedJdContext, SavedJdProvider(), useSavedJds(), AppContent() (+72 more)
...
Cohesion: 0.08
Nodes (40): AnalysisRunContext, useAnalysisRun(), SupabaseConfigError(), AuthContext, AuthContextType, AuthProvider(), EmailAuthResult, MAX_BATCH_BY_PLAN (+32 more)
...
Cohesion: 0.08
Nodes (18): SavedJdsListModalProps, about, admin, billing, footer, history, LocaleEntry, SECTIONS (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (23): AppErrorBoundary, UIProvider(), AnalyticsBootstrap(), CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent(), ensureDataLayer() (+15 more)
...
## Knowledge Gaps
- **335 isolated node(s):** `Cấu trúc & Runtime`, `1. Cấu hình (`/api/config`)`, `2. Trích xuất PDF`, `3. Xác thực reCAPTCHA`, `4. Thanh toán PayOS (`/api/payment/create` & `/api/payment/webhook`)` (+330 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 2`, `Community 4`, `Community 10`, `Community 11`, `Community 12`, `Community 17`, `Community 19`, `Community 29`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 4` to `Community 0`, `Community 2`, `Community 10`, `Community 12`, `Community 19`, `Community 21`, `Community 29`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 2`, `Community 4`, `Community 11`, `Community 12`, `Community 17`, `Community 29`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **What connects `Cấu trúc & Runtime`, `1. Cấu hình (`/api/config`)`, `2. Trích xuất PDF` to the rest of the system?**
