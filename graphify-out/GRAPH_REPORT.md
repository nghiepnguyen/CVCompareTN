...
## Corpus Check
- 203 files · ~115,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1373 nodes · 2616 edges · 85 communities (79 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26cc622e`
...
- `Footer()` --calls--> `useUI()`  [EXTRACTED]
  components/layout/Footer.tsx → src/context/UIContext.tsx
...
Cohesion: 0.09
Nodes (40): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), SavedCvContext, useSavedCvs(), AnalysisContextType, AnalysisRunContextType, EagerProcessResult (+32 more)
...
Cohesion: 0.09
Nodes (22): AboutPage(), SectionCardProps, PrivacyPolicyPage(), TermsOfServicePage(), useUI(), RecruiterProvider(), AnalysisLoadingState(), AnalysisLoadingStateProps (+14 more)
...
Cohesion: 0.19
Nodes (19): useAuth(), Header(), formatPlanExpiryDate(), HISTORY_DAYS_BY_PLAN, isProPlan(), isRecruiterPlan(), MAX_CAMPAIGN_CVS, MAX_CAMPAIGNS (+11 more)
...
Cohesion: 0.25
Nodes (19): analyzeCV(), parseGeminiJson(), repairTruncatedJson(), stripControlChars(), buildAnalyzePromptEn(), buildAnalyzePromptVi(), coerceJsonField(), normalizeAnalysisPayload() (+11 more)
...
Cohesion: 0.18
Nodes (15): detailedComparisonHasRows(), IMPACTS, AnalysisResult, ATSEvaluation, CategorizedPoint, ComparisonItem, DetailedComparison, MissingGap (+7 more)
...
Cohesion: 0.17
Nodes (11): MobileBottomNav(), MobileBottomNavProps, Tab, tabFromPath(), UIContext, UIContextType, UIProvider(), UpgradePrompt() (+3 more)
...
Cohesion: 0.22
Nodes (10): useAnalysis(), SavedCvProvider(), SavedJdContext, SavedJdProvider(), useSavedJds(), AppContent(), deleteSavedJD(), getSavedJDs() (+2 more)
...
Cohesion: 0.4
Nodes (4): CreateCampaignModal(), CreateCampaignModalProps, useRecruiter(), CampaignDetailView()
...
Cohesion: 0.4
Nodes (4): isRecord(), normalizeParsedCV(), mapHistory(), result
...
## Knowledge Gaps
- **481 isolated node(s):** `Project Context`, `1. Code Style & Conventions`, `2. Architecture & Data Flow`, `3. UI/UX Guidelines`, `4. Secrets & Repository Hygiene` (+476 more)
...
- **Why does `supabase` connect `Community 6` to `Community 33`, `Community 34`, `Community 4`, `Community 11`, `Community 44`, `Community 15`, `Community 54`, `Community 22`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `useUI()` connect `Community 11` to `Community 34`, `Community 2`, `Community 4`, `Community 6`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 48`, `Community 44`, `Community 21`, `Community 55`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `AnalysisResult` connect `Community 22` to `Community 19`, `Community 21`?**
