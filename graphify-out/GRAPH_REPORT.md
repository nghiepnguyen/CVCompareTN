...
## Corpus Check
- 184 files · ~99,486 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1019 nodes · 1944 edges · 58 communities (54 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b91a6ec4`
...
Cohesion: 0.08
Nodes (39): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), SupabaseConfigError(), AuthContext, AuthContextType, AuthProvider(), bootstrapSupabase() (+31 more)
...
Cohesion: 0.11
Nodes (18): SavedCvContext, useSavedCvs(), SavedJdContext, AnalysisContextType, AnalysisRunContextType, SavedCvContextType, SavedJdContextType, SavedCvsListModalProps (+10 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (24): AboutPage, AdminView, DashboardView, HistoryView, LandingView, NoPermissionView, PaymentCancelView, PaymentSuccessView (+16 more)
...
Cohesion: 0.25
Nodes (14): Header(), formatPlanExpiryDate(), HISTORY_DAYS_BY_PLAN, isProPlan(), isRecruiterPlan(), MAX_BATCH_BY_PLAN, MAX_CAMPAIGN_CVS, MAX_CAMPAIGNS (+6 more)
...
Cohesion: 0.21
Nodes (13): useAnalysis(), SavedCvProvider(), SavedJdProvider(), useSavedJds(), AppContent(), useAuth(), RecruiterProvider(), AdminView() (+5 more)
...
Cohesion: 0.17
Nodes (9): AboutPage(), SectionCardProps, PrivacyPolicyPage(), TermsOfServicePage(), useUI(), AnalysisLoadingState(), AnalysisLoadingStateProps, STEPS (+1 more)
...
## Knowledge Gaps
- **329 isolated node(s):** `Entry & shell (`src/app/`)`, `Recruiter state (`src/context/recruiter/`)`, `Global state (`src/context/`)`, `Custom hooks (`src/hooks/`)`, `Test suite (`src/__tests__/`)` (+324 more)
...
- **Why does `useUI()` connect `Community 24` to `Community 0`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 25`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 22` to `Community 0`, `Community 6`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 25`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 17` to `Community 0`, `Community 6`, `Community 9`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 22`, `Community 24`, `Community 25`, `Community 27`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
