...
## Summary
- 1090 nodes · 2126 edges · 48 communities (44 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `191e996c`
...
5. `handlePaymentWebhook()` - 15 edges
6. `isProPlan()` - 15 edges
7. `LandingLabels` - 15 edges
8. `handlePaymentCreate()` - 14 edges
9. `handlePaymentConfirm()` - 14 edges
10. `Hạn mức phân tích CV/tháng (Supabase — không phải GA4)` - 14 edges
...
- `handler()` --calls--> `handlePaymentWebhook()`  [EXTRACTED]
  api/payment/webhook.ts → _server-lib/payment/handlers.ts
- `createSignatureFromObject()` --calls--> `objectToSignString()`  [EXTRACTED]
  _server-lib/payment/payos.ts → lib/payment/payos.ts
- `AdminView()` --calls--> `useAuth()`  [EXTRACTED]
  AdminView.tsx → src/context/AuthContext.tsx

## Communities (48 total, 4 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (71): useAnalysis(), useAnalysisRun(), SavedCvProvider(), useSavedCvs(), SavedJdContext, SavedJdProvider(), useSavedJds(), MobileBottomNavProps (+63 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (50): AnalysisRunContext, AnalysisRunProvider(), SupabaseConfigError(), AuthContext, AuthContextType, AuthProvider(), EmailAuthResult, MAX_BATCH_BY_PLAN (+42 more)
...
Cohesion: 0.05
Nodes (37): binaryString, bytes, corsHeaders, htmlToText(), apiLimiter, emailLimiter, staticLimiter, strictLimiter (+29 more)
...
Cohesion: 0.12
Nodes (28): AboutPage(), SectionCardProps, CtaSection(), DemoResultSection(), FaqSection(), HeroSection(), HowItWorksSection(), buildRows() (+20 more)
...
Cohesion: 0.14
Nodes (33): handler(), activateProForOrder(), fetchProfileForEmail(), handlePaymentConfirm(), handlePaymentCreate(), handlePaymentWebhook(), isWebhookPaymentSuccess(), normalizeOrderCode() (+25 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (31): handler(), handler(), AMP, escapeHtml(), validateEmail(), validateFeedbackInput(), validateLength(), validateWelcomeEmailInput() (+23 more)
...
Cohesion: 0.09
Nodes (27): AboutPage, AdminView, AppContent(), AuthModal, DashboardView, HistoryView, LandingView, NoPermissionView (+19 more)
...
Cohesion: 0.18
Nodes (20): CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent(), ensureDataLayer(), eventQueue, flushEventQueue(), getAnalyticsConsent() (+12 more)
...
Cohesion: 0.16
Nodes (12): SavedCvContext, AnalysisContextType, AnalysisRunContextType, SavedCvContextType, SavedJdContextType, SavedCvsListModalProps, MAX_SAVED_CV_BY_PLAN, deleteSavedCV() (+4 more)
...
Cohesion: 0.15
Nodes (8): CampaignCard(), CampaignCardProps, useStatusConfig(), CandidatePanel(), CandidatePanelProps, CandidateTable(), CandidateTableProps, CampaignDetailViewProps
...
Cohesion: 0.14
Nodes (13): 1. Cấu hình (`/api/config`), 2. Trích xuất PDF, 3. Xác thực reCAPTCHA, 4. Thanh toán PayOS (`/api/payment/create` & `/api/payment/webhook`), 5. Hệ thống Email (Resend), Biến môi trường (Environment Variables), Các chức năng chính (Routes), Cấu trúc & Runtime (+5 more)

### Community 25 - "Community 25"
Cohesion: 0.16
Nodes (13): 1. Internal API (Backend Proxy), 2. Dịch vụ lưu trữ & xác thực (Supabase), Danh sách API Endpoints (cvFit), Edge Function (tùy chọn — Supabase), `GET /api/config`, Hệ thống Email (Resend), `POST /api/send-feedback`, `POST /api/send-welcome-email` (+5 more)
...
## Knowledge Gaps
- **344 isolated node(s):** `AMP`, `PayosPaymentRequestInfo`, `VipUpgradeEmailParams`, `ValidationError`, `Project Context` (+339 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 1`, `Community 5`, `Community 13`, `Community 14`, `Community 17`, `Community 20`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 5` to `Community 0`, `Community 1`, `Community 13`, `Community 16`, `Community 17`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 1`, `Community 5`, `Community 13`, `Community 14`, `Community 20`, `Community 31`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `AMP`, `PayosPaymentRequestInfo`, `VipUpgradeEmailParams` to the rest of the system?**
