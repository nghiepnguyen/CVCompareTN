...
## Corpus Check
- 186 files · ~113,389 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1297 nodes · 2436 edges · 82 communities (76 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7eac36b9`
...
- `PrintView()` --calls--> `isProPlan()`  [EXTRACTED]
  PrintView.tsx → src/lib/planLimits.ts
- `ResultView()` --calls--> `useUI()`  [EXTRACTED]
  components/views/ResultView.tsx → src/context/UIContext.tsx

## Communities (82 total, 6 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (55): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), AnalysisRunContextType, SupabaseConfigError(), AuthContext, AuthContextType, AuthProvider() (+47 more)
...
Cohesion: 0.17
Nodes (22): SavedCvContext, SavedCvProvider(), useSavedCvs(), SavedJdContext, AnalysisContextType, SavedCvContextType, SavedJdContextType, trackEvent() (+14 more)

### Community 11 - "Community 11"
Cohesion: 0.12
Nodes (20): AppErrorBoundary, AnalyticsBootstrap(), CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent(), ensureDataLayer(), eventQueue (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (18): AboutPage(), SectionCardProps, PrivacyPolicyPage(), TermsOfServicePage(), useUI(), AnalysisLoadingState(), AnalysisLoadingStateProps, STEPS (+10 more)
...
Cohesion: 0.14
Nodes (18): buildRewritePromptEn(), buildRewritePromptVi(), DetailedComparisonPromptParams, PromptParams, RewritePromptParams, ParsedCV, RewriteSuggestion, handler() (+10 more)

### Community 19 - "Community 19"
Cohesion: 0.24
Nodes (19): analyzeCV(), parseGeminiJson(), buildAnalyzePromptEn(), buildAnalyzePromptVi(), coerceJsonField(), normalizeAnalysisPayload(), normalizeCategoryScores(), normalizeComparisonItems() (+11 more)
...
Cohesion: 0.17
Nodes (14): detailedComparisonHasRows(), IMPACTS, AnalysisResult, ATSEvaluation, CategorizedPoint, CategorizedScore, ComparisonItem, DetailedComparison (+6 more)
...
Cohesion: 0.25
Nodes (11): useAnalysis(), SavedJdProvider(), useSavedJds(), AppContent(), useAuth(), RecruiterProvider(), AnalysisInputView(), DashboardView() (+3 more)
...
- **Why does `useUI()` connect `Community 12` to `Community 0`, `Community 1`, `Community 33`, `Community 41`, `Community 10`, `Community 43`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 25`, `Community 28`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `supabase` connect `Community 0` to `Community 41`, `Community 10`, `Community 15`, `Community 53`, `Community 22`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `AnalysisResult` connect `Community 22` to `Community 25`, `Community 19`?**
