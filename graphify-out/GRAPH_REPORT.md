...
## Corpus Check
- 215 files · ~123,690 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1392 nodes · 2677 edges · 92 communities (87 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3eeebcf1`
...
5. `supabase` - 24 edges
6. `isProPlan()` - 19 edges
7. `isRecruiterPlan()` - 19 edges
8. `analyzeCV()` - 17 edges
...
- `handler()` --calls--> `analyzeCV()`  [EXTRACTED]
  api/analyze.ts → analysisService.ts
- `analyzeCV()` --calls--> `callAnalyzeProxy()`  [EXTRACTED]
  analysisService.ts → src/services/ai/geminiProvider.ts
...
Cohesion: 0.11
Nodes (38): AuthContext, AuthContextType, EmailAuthResult, AdminUsersState, useAdminUsers(), initSentry(), SCRUB_KEYS, setSentryUser() (+30 more)
...
Cohesion: 0.14
Nodes (27): CtaSection(), DemoResultSection(), FaqSection(), HeroSection(), HowItWorksSection(), buildRows(), ComparisonRow, Plan (+19 more)
...
Cohesion: 0.16
Nodes (24): Header(), formatPlanExpiryDate(), HISTORY_DAYS_BY_PLAN, isProPlan(), isRecruiterPlan(), MAX_CAMPAIGN_CVS, MAX_CAMPAIGNS, MAX_SAVED_JD_BY_PLAN (+16 more)
...
Cohesion: 0.12
Nodes (14): AboutPage(), SectionCardProps, PrivacyPolicyPage(), TermsOfServicePage(), useUI(), Footer(), resetAnalyticsConsentPrompt(), AnalysisLoadingState() (+6 more)

### Community 19 - "Community 19"
Cohesion: 0.25
Nodes (19): analyzeCV(), parseGeminiJson(), repairTruncatedJson(), stripControlChars(), getGeminiClient(), coerceJsonField(), detailedComparisonHasRows(), IMPACTS (+11 more)
...
Cohesion: 0.19
Nodes (19): CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent(), ensureDataLayer(), eventQueue, flushEventQueue(), getAnalyticsConsent() (+11 more)
...
Cohesion: 0.22
Nodes (12): useAnalysis(), AppContent(), useAuth(), cn(), RecruiterProvider(), UpgradePrompt(), UpgradePromptProps, AnalysisInputView() (+4 more)
...
Cohesion: 0.21
Nodes (7): AppErrorBoundary, AppShell(), RECAPTCHA_SITE_KEY, RecaptchaWrapper(), AuthProvider(), UIProvider(), AnalyticsBootstrap()
...
Cohesion: 0.33
Nodes (7): SavedJdContext, SavedJdProvider(), useSavedJds(), deleteSavedJD(), getSavedJDs(), SavedJD, saveJDToProfile()
...
Cohesion: 0.32
Nodes (6): ConfirmPaymentResponse, confirmProPayment(), CreateCheckoutResponse, parsePaymentApiResponse(), PaymentApiError, PaymentSuccessView()
...
## Knowledge Gaps
- **481 isolated node(s):** `EmailAuthResult`, `UserAvatarProps`, `code:text (┌───────────────────────────────────────────────────────────)`, `Luồng`, `Lưu trữ consent` (+476 more)
...
- **Why does `supabase` connect `Community 2` to `Community 3`, `Community 11`, `Community 43`, `Community 14`, `Community 51`, `Community 23`, `Community 26`, `Community 62`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `useUI()` connect `Community 18` to `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 45`, `Community 43`, `Community 17`, `Community 51`, `Community 22`, `Community 26`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `AnalysisResult` connect `Community 23` to `Community 8`, `Community 19`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **What connects `EmailAuthResult`, `UserAvatarProps`, `code:text (┌───────────────────────────────────────────────────────────)` to the rest of the system?**
