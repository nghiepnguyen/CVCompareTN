...
Cohesion: 0.09
Nodes (26): MobileBottomNavProps, Tab, tabFromPath(), UIContext, UIContextType, AnalysisDetailsTab, AnalysisDetailsTabProps, AnalysisLoadingState() (+18 more)
...
Cohesion: 0.11
Nodes (26): useAnalysis(), SavedJdProvider(), useSavedJds(), AuthModal(), PrivacyPolicyPage(), TermsOfServicePage(), useAuth(), useUI() (+18 more)
...
Cohesion: 0.12
Nodes (22): handler(), handler(), CachedUser, decodeJwtPayload(), getCachedUser(), getSupabaseAdmin(), getUserFromBearerToken(), setCachedUser() (+14 more)

### Community 15 - "Community 15"
Cohesion: 0.2
Nodes (17): buildRewritePromptEn(), buildRewritePromptVi(), generateFullRewrite(), getEffectivePlan(), handleAnalyze(), HandlerResult, handler(), handleParseCv() (+9 more)
...
Cohesion: 0.22
Nodes (17): handler(), activateProForOrder(), fetchProfileForEmail(), handlePaymentConfirm(), handlePaymentCreate(), handlePaymentWebhook(), isWebhookPaymentSuccess(), normalizeOrderCode() (+9 more)
...
Cohesion: 0.23
Nodes (17): convertObjToQueryStr(), createPaymentRequestSignature(), createPayosPaymentLink(), createSignatureFromObject(), fetchPaymentRequestInfo(), getAppBaseUrl(), getChecksumKey(), getPayosHeaders() (+9 more)
...
Cohesion: 0.19
Nodes (8): CandidateAnalysisData, CandidateDetail(), CandidatePanel(), CandidatePanelProps, ScoreGauge(), CandidateTable(), CandidateTableProps, CampaignDetailViewProps
...
Cohesion: 0.18
Nodes (9): AMP, escapeHtml(), params, resendClient, router, safeUserEmail, safeUserName, validationErrors (+1 more)
...
Cohesion: 0.38
Nodes (8): handleFeedback(), handler(), handleWelcome(), verifyRecaptcha(), handleSendFeedback(), handleSendWelcomeEmail(), escapeHtml(), AMP

### Community 45 - "Community 45"
Cohesion: 0.18
Nodes (11): code:typescript (catch (error: any) {), code:typescript (catch (error: unknown) {), code:block12 (script-src 'self' 'unsafe-inline' 'unsafe-eval' ...), code:typescript (// api/extract-pdf.ts — no auth check), Findings, 🟠 HIGH-02: No Authentication on PDF Extraction Endpoint, 🔵 LOW-01: CSP Allows `unsafe-inline` and `unsafe-eval`, 🔵 LOW-02: Supabase Anon Key Exposed (By Design, but Documented) (+3 more)
...
Cohesion: 0.32
Nodes (5): HandlerResult, params, router, RecaptchaResult, verifyRecaptcha()
...
- **Why does `useUI()` connect `Community 11` to `Community 32`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 34`, `Community 6`, `Community 12`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 61`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 32`, `Community 34`, `Community 3`, `Community 4`, `Community 6`, `Community 11`, `Community 12`, `Community 20`, `Community 22`, `Community 24`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `getUserFromBearerToken()` connect `Community 14` to `Community 0`, `Community 33`, `Community 21`, `Community 15`?**
