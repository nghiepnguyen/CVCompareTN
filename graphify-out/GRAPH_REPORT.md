# Graph Report - cv-compare-tn  (2026-06-22)

## Corpus Check
- 203 files · ~116,210 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1374 nodes · 2619 edges · 86 communities (79 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4890eafa`
...
Cohesion: 0.1
Nodes (36): MobileBottomNav(), MobileBottomNavProps, CtaSection(), DemoResultSection(), FaqSection(), HeroSection(), HowItWorksSection(), buildRows() (+28 more)
...
Cohesion: 0.08
Nodes (17): about, admin, billing, footer, history, LocaleEntry, SECTIONS, input (+9 more)

### Community 11 - "Community 11"
Cohesion: 0.1
Nodes (22): AppErrorBoundary, RECAPTCHA_SITE_KEY, AnalyticsBootstrap(), CookieConsentBanner(), CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent() (+14 more)
...
Cohesion: 0.19
Nodes (17): Header(), formatPlanExpiryDate(), HISTORY_DAYS_BY_PLAN, isProPlan(), isRecruiterPlan(), MAX_CAMPAIGN_CVS, MAX_CAMPAIGNS, MAX_SAVED_JD_BY_PLAN (+9 more)

### Community 14 - "Community 14"
Cohesion: 0.16
Nodes (17): useAnalysis(), SavedJdContext, SavedJdProvider(), useSavedJds(), AppContent(), PrivacyPolicyPage(), TermsOfServicePage(), useAuth() (+9 more)
...
Cohesion: 0.14
Nodes (11): AnalysisLoadingState(), AnalysisLoadingStateProps, STEPS, DetailedComparisonTab(), OptimizationTab, OptimizationTabProps, ParsedCVTab(), ParsedCVTabProps (+3 more)
...
Cohesion: 0.27
Nodes (8): Tab, tabFromPath(), UIContext, UIContextType, UIProvider(), UpgradePrompt(), UpgradePromptProps, UI_LABELS
...
Cohesion: 0.48
Nodes (5): SavedJdContextType, deleteSavedJD(), getSavedJDs(), SavedJD, saveJDToProfile()
...
## Knowledge Gaps
- **481 isolated node(s):** `SectionCardProps`, `Project Context`, `1. Code Style & Conventions`, `2. Architecture & Data Flow`, `3. UI/UX Guidelines` (+476 more)
...
- **Why does `supabase` connect `Community 6` to `Community 32`, `Community 3`, `Community 43`, `Community 14`, `Community 15`, `Community 20`, `Community 52`, `Community 54`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `AnalysisResult` connect `Community 20` to `Community 21`, `Community 22`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `useUI()` connect `Community 14` to `Community 2`, `Community 3`, `Community 6`, `Community 38`, `Community 11`, `Community 12`, `Community 13`, `Community 43`, `Community 15`, `Community 48`, `Community 17`, `Community 52`, `Community 22`, `Community 61`, `Community 30`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **What connects `SectionCardProps`, `Project Context`, `1. Code Style & Conventions` to the rest of the system?**
