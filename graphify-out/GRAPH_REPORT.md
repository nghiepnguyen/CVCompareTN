...
## Summary
- 853 nodes · 1657 edges · 43 communities (39 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `642ec1d8`
...
9. `handlePaymentWebhook()` - 11 edges
10. `getSupabaseAdmin()` - 11 edges
...
- `handlePaymentCreate()` --calls--> `getSupabaseAdmin()`  [EXTRACTED]
  server/lib/paymentHandlers.ts → api/payment/lib/supabaseAdmin.ts

## Communities (43 total, 4 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (63): useAnalysis(), AdminView, AppContent(), DashboardView, HistoryView, LandingView, NoPermissionView, PaymentCancelView (+55 more)
...
Cohesion: 0.13
Nodes (24): formatPlanExpiryDate(), HISTORY_DAYS_BY_PLAN, isProPlan(), MAX_BATCH_BY_PLAN, MAX_SAVED_CV_BY_PLAN, MAX_SAVED_JD_BY_PLAN, ConfirmPaymentResponse, confirmProPayment() (+16 more)
...
Cohesion: 0.11
Nodes (20): SavedCvContext, SavedCvProvider(), useSavedCvs(), SavedJdContext, SavedJdProvider(), useSavedJds(), AnalysisContextType, AnalysisRunContextType (+12 more)
...
## Knowledge Gaps
- **266 isolated node(s):** `env`, `router`, `router`, `params`, `resendClient` (+261 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 2`, `Community 9`, `Community 10`, `Community 11`, `Community 14`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 2`, `Community 9`, `Community 10`, `Community 11`, `Community 14`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 0` to `Community 9`, `Community 2`, `Community 10`, `Community 14`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `env`, `router`, `router` to the rest of the system?**
