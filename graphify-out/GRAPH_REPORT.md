...
## Summary
- 886 nodes · 1695 edges · 41 communities (37 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a795c9d4`
...
- `notifyVipUpgrade()` --calls--> `sendVipUpgradeEmail()`  [EXTRACTED]
  handlers.ts → vipUpgradeEmail.ts

## Communities (41 total, 4 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (69): useAnalysis(), AnalysisRunProvider(), SavedCvProvider(), useSavedCvs(), SavedJdProvider(), useSavedJds(), AboutPage, AdminView (+61 more)
...
Cohesion: 0.08
Nodes (42): AnalysisRunContext, useAnalysisRun(), SavedJdsListModal(), SavedJdsListModalProps, cleanText(), ProcessedFile, processFile(), result (+34 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (37): binaryString, bytes, corsHeaders, AMP, escapeHtml(), apiLimiter, emailLimiter, staticLimiter (+29 more)
...
## Knowledge Gaps
- **277 isolated node(s):** `PDF_HEADER`, `Mục tiêu chính (Core Objectives)`, `Tính năng nổi bật (Key Features)`, `Tài liệu kỹ thuật`, `Entry & shell (`src/app/`)` (+272 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 2`, `Community 10`, `Community 13`, `Community 7`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 2`, `Community 10`, `Community 13`, `Community 7`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 0` to `Community 18`, `Community 2`, `Community 10`, `Community 7`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `PDF_HEADER`, `Mục tiêu chính (Core Objectives)`, `Tính năng nổi bật (Key Features)` to the rest of the system?**
