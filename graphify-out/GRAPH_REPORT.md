# Graph Report - cv-compare-tn  (2026-06-02)

## Corpus Check
- 185 files · ~107,973 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1045 nodes · 2013 edges · 52 communities (48 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `334125d6`
...
Cohesion: 0.05
Nodes (77): useAnalysis(), AppContent(), MobileBottomNavProps, AboutPage(), SectionCardProps, PrivacyPolicyPage(), TermsOfServicePage(), useAuth() (+69 more)
...
Cohesion: 0.06
Nodes (48): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), AuthModal(), ERROR_KEY_MAP, FormErrors, getErrorKey(), resolveError() (+40 more)
...
Cohesion: 0.15
Nodes (26): CtaSection(), DemoResultSection(), FaqSection(), HeroSection(), HowItWorksSection(), buildRows(), ComparisonRow, Plan (+18 more)
...
Cohesion: 0.1
Nodes (21): SavedCvContext, SavedCvProvider(), useSavedCvs(), SavedJdContext, SavedJdProvider(), useSavedJds(), AnalysisContextType, AnalysisRunContextType (+13 more)
...
Cohesion: 0.18
Nodes (9): AMP, escapeHtml(), params, resendClient, router, safeContent, safeTitle, safeUserEmail (+1 more)

### Community 24 - "Community 24"
Cohesion: 0.21
Nodes (5): CandidatePanel(), CandidatePanelProps, CandidateTable(), CandidateTableProps, CampaignDetailViewProps
...
## Knowledge Gaps
- **338 isolated node(s):** `Entry & shell (`src/app/`)`, `Recruiter state (`src/context/recruiter/`)`, `Global state (`src/context/`)`, `Custom hooks (`src/hooks/`)`, `Test suite (`src/__tests__/`)` (+333 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 2`, `Community 6`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 24`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 0`, `Community 2`, `Community 10`, `Community 13`, `Community 15`, `Community 24`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 2`, `Community 6`, `Community 11`, `Community 12`, `Community 13`?**
