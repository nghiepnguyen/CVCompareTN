...
- `AdminView()` --calls--> `formatLabel()`  [EXTRACTED]
  AdminView.tsx → src/translations/index.ts
- `AdminView()` --calls--> `useUI()`  [EXTRACTED]
  AdminView.tsx → src/context/UIContext.tsx
...
Cohesion: 0.05
Nodes (51): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), SavedCvContext, useSavedCvs(), SavedJdContext, AnalysisContextType, AnalysisRunContextType (+43 more)
...
Cohesion: 0.16
Nodes (12): ConfirmPaymentResponse, confirmProPayment(), CreateCheckoutResponse, createProCheckout(), createRecruiterCheckout(), parsePaymentApiResponse(), PaymentApiError, PaymentSuccessView() (+4 more)
...
Cohesion: 0.31
Nodes (6): Tab, tabFromPath(), UIContext, UIContextType, UIProvider(), UI_LABELS
