...
## Summary
- 477 nodes · 731 edges · 27 communities (25 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5dc72945`
...
- `AnalysisRunProvider()` --calls--> `useAuth()`  [EXTRACTED]
  context/analysis/AnalysisRunContext.tsx → AuthContext.tsx

## Communities (27 total, 2 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (49): AnalysisRunProvider(), SavedJdContext, SavedJdProvider(), useSavedJds(), AdminView, AppContent(), DashboardView, HistoryView (+41 more)
...
Cohesion: 0.11
Nodes (11): Tab, UIContext, UIContextType, admin, billing, LocaleEntry, SECTIONS, UI_LABELS (+3 more)
...
## Knowledge Gaps
- **181 isolated node(s):** `AnalysisLoadingStateProps`, `AnalysisRunContext`, `result`, `FaqItem`, `BLOCKED_HOSTNAMES` (+176 more)
...
- **Why does `useUI()` connect `Community 0` to `Community 9`, `Community 4`, `Community 7`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 9`, `Community 4`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `formatLabel()` connect `Community 0` to `Community 9`, `Community 4`, `Community 7`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `AnalysisLoadingStateProps`, `AnalysisRunContext`, `result` to the rest of the system?**
