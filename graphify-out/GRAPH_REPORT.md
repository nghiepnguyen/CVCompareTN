# Graph Report - cv-compare-tn  (2026-07-01)

## Corpus Check
- 221 files · ~126,158 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1407 nodes · 2719 edges · 93 communities (88 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17bb721c`
...
2. `cn()` - 58 edges
3. `useAuth()` - 57 edges
4. `formatLabel()` - 31 edges
5. `supabase` - 24 edges
6. `analyzeCV()` - 20 edges
7. `isProPlan()` - 19 edges
8. `isRecruiterPlan()` - 19 edges
9. `handlePaymentWebhook()` - 17 edges
10. `getUserFromBearerToken()` - 17 edges
...
- `AuthModal()` --calls--> `useAuth()`  [EXTRACTED]
  src/components/auth/AuthModal.tsx → context/AuthContext.tsx
...
Cohesion: 0.07
Nodes (53): handleAnalyze(), HandlerResult, withTimeout(), handler(), isPdfBuffer(), PDF_HEADER, handler(), startServer() (+45 more)

### Community 1 - "Community 1"
Cohesion: 0.1
Nodes (42): HandlerResult, activateProForOrder(), fetchProfileForEmail(), handlePaymentConfirm(), handlePaymentCreate(), handlePaymentWebhook(), isWebhookPaymentSuccess(), normalizeOrderCode() (+34 more)

### Community 2 - "Community 2"
Cohesion: 0.12
Nodes (37): AuthContext, AuthContextType, EmailAuthResult, AdminUsersState, useAdminUsers(), initSentry(), SCRUB_KEYS, setSentryUser() (+29 more)

### Community 3 - "Community 3"
Cohesion: 0.1
Nodes (39): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), SavedCvContext, useSavedCvs(), AnalysisContextType, AnalysisRunContextType, EagerProcessResult (+31 more)
...
Cohesion: 0.08
Nodes (29): AboutPage, AdminView, AuthModal, DashboardView, HistoryView, LandingView, NoPermissionView, PaymentCancelView (+21 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (19): PrivacyPolicyPage(), TermsOfServicePage(), useAuth(), useUI(), RecruiterProvider(), AnalysisLoadingState(), AnalysisLoadingStateProps, STEPS (+11 more)

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (21): Header(), formatPlanExpiryDate(), HISTORY_DAYS_BY_PLAN, isProPlan(), isRecruiterPlan(), MAX_CAMPAIGN_CVS, MAX_CAMPAIGNS, MAX_SAVED_JD_BY_PLAN (+13 more)
...
Cohesion: 0.19
Nodes (18): CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent(), ensureDataLayer(), eventQueue, flushEventQueue(), getAnalyticsConsent() (+10 more)

### Community 21 - "Community 21"
Cohesion: 0.16
Nodes (15): isRecord(), AnalysisResult, ATSEvaluation, CategorizedPoint, ComparisonItem, DetailedComparison, MissingGap, ParsedCV (+7 more)

### Community 22 - "Community 22"
Cohesion: 0.26
Nodes (16): ANALYSIS_RESPONSE_SCHEMA, comparisonItemSchema, coerceJsonField(), detailedComparisonHasRows(), IMPACTS, normalizeAnalysisPayload(), normalizeCategoryScores(), normalizeComparisonItems() (+8 more)
...
Cohesion: 0.2
Nodes (8): AppContent(), AppErrorBoundary, AppShell(), RECAPTCHA_SITE_KEY, RecaptchaWrapper(), AuthProvider(), UIProvider(), AnalyticsBootstrap()

### Community 29 - "Community 29"
Cohesion: 0.26
Nodes (11): analyzeCV(), normalizeParsedCV(), buildAnalyzePrompt(), buildAnalyzePromptEn(), buildAnalyzePromptVi(), PromptParams, CategorizedScore, handler() (+3 more)

### Community 30 - "Community 30"
Cohesion: 0.24
Nodes (9): useAnalysis(), SavedCvProvider(), SavedJdContext, SavedJdProvider(), useSavedJds(), deleteSavedJD(), getSavedJDs(), SavedJD (+1 more)
...
Cohesion: 0.23
Nodes (9): buildRewritePromptEn(), buildRewritePromptVi(), generateFullRewrite(), REWRITE_SCHEMA, handler(), params, router, RecaptchaResult (+1 more)
...
Cohesion: 0.22
Nodes (9): authResult, detailedComparison, gemini, geminiApiKey, parsed, { parsedCV, jd, language = 'vi' }, parseGeminiJson(), router (+1 more)
...
Cohesion: 0.43
Nodes (4): parseGeminiJson(), repairTruncatedJson(), stripControlChars(), getGeminiClient()
...
Cohesion: 0.83
Nodes (3): handler(), parseGeminiJson(), stripCtrl()
...
## Knowledge Gaps
- **485 isolated node(s):** `comparisonItemSchema`, `REWRITE_SCHEMA`, `PromptParams`, `SCRUB_KEYS`, `HandlerResult` (+480 more)
...
- **Why does `supabase` connect `Community 2` to `Community 3`, `Community 12`, `Community 45`, `Community 15`, `Community 21`, `Community 30`, `Community 62`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `useUI()` connect `Community 12` to `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 48`, `Community 17`, `Community 45`, `Community 20`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `AnalysisResult` connect `Community 21` to `Community 8`, `Community 22`, `Community 63`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **What connects `comparisonItemSchema`, `REWRITE_SCHEMA`, `PromptParams` to the rest of the system?**
