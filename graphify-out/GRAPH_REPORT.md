# Graph Report - cv-compare-tn  (2026-07-26)

## Corpus Check
- 246 files · ~145,848 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1579 nodes · 3820 edges · 88 communities (82 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c615193e`
...
2. `cn()` - 119 edges
3. `useAuth()` - 68 edges
4. `formatLabel()` - 41 edges
5. `supabase` - 33 edges
6. `getUserFromBearerToken()` - 30 edges
7. `LandingLabels` - 29 edges
8. `SectionTheme` - 26 edges
9. `isRecruiterPlan()` - 26 edges
10. `SectionBadge()` - 25 edges

## Surprising Connections (you probably didn't know these)
- `startServer()` --calls--> `initSentryServer()`  [EXTRACTED]
  server.ts → _server-lib/sentry.ts
- `handler()` --calls--> `initSentryServer()`  [EXTRACTED]
  api/rewrite-cv.ts → _server-lib/sentry.ts
- `handler()` --calls--> `initSentryServer()`  [EXTRACTED]
  api/analyze.ts → _server-lib/sentry.ts
- `handler()` --calls--> `initSentryServer()`  [EXTRACTED]
  api/payment.ts → _server-lib/sentry.ts
- `handler()` --calls--> `initSentryServer()`  [EXTRACTED]
  api/extract-pdf.ts → _server-lib/sentry.ts

## Communities (88 total, 6 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (84): analyzeCV(), parseGeminiJson(), repairTruncatedJson(), stripControlChars(), extractTokenUsage(), getGeminiClient(), TokenUsage, generateParsedCV() (+76 more)

### Community 1 - "Community 1"
Cohesion: 0.11
Nodes (43): AboutPage(), SectionBadge(), SectionCard(), SectionCardProps, CtaSection(), DemoResultSection(), FaqSection(), EASE (+35 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (50): AnalysisRunContext, AnalysisRunProvider(), useAnalysisRun(), SavedCvContext, SavedCvProvider(), useSavedCvs(), AnalysisContextType, AnalysisRunContextType (+42 more)

### Community 3 - "Community 3"
Cohesion: 0.1
Nodes (45): extractTextFromImage(), AnalyzeRequest, callAnalyzeProxy(), getGeminiClient(), ERROR_KEY_MAP, FormErrors, getErrorKey(), resolveError() (+37 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (38): AboutPage, AdminView, AppContent(), AuthModal, DashboardView, HistoryView, LandingView, NoPermissionView (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (31): useAnalysis(), SavedJdProvider(), AuthModal(), PrivacyPolicyPage(), TermsOfServicePage(), useAuth(), useUI(), RecruiterProvider() (+23 more)
...
Cohesion: 0.05
Nodes (41): Admin Report tab (thống kê lượt phân tích theo ngày), Admin UI (`AdminView`), API theo dõi sự kiện, Bảng `analysis_log`, Bảng & cột, Bảng event đang track, Bảo mật RPC (Security Advisor), Biến môi trường (+33 more)
...
Cohesion: 0.09
Nodes (23): MobileBottomNavProps, Tab, tabFromPath(), UIContext, UIContextType, CampaignCard(), CampaignCardProps, useStatusConfig() (+15 more)

### Community 12 - "Community 12"
Cohesion: 0.16
Nodes (22): Logo(), CookieConsentBannerProps, AnalyticsConsent, applyGrantedConsent(), denyAnalyticsConsent(), ensureDataLayer(), eventQueue, flushEventQueue() (+14 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (14): about, admin, billing, footer, history, LocaleEntry, SECTIONS, input (+6 more)

### Community 14 - "Community 14"
Cohesion: 0.2
Nodes (18): buildRewritePromptEn(), buildRewritePromptVi(), generateFullRewrite(), getEffectivePlan(), handleAnalyze(), HandlerResult, handler(), handleParseCv() (+10 more)
...
Cohesion: 0.18
Nodes (16): CvMarkdownBody, markdownToPlainText(), cleanMarkdownForPremium(), extractCandidateName(), ActionButtons(), ActionButtonsProps, FullCVTab, FullCVTabProps (+8 more)

### Community 18 - "Community 18"
Cohesion: 0.15
Nodes (17): ConfirmPaymentResponse, confirmProPayment(), CreateCheckoutResponse, createProCheckout(), createRecruiterCheckout(), parsePaymentApiResponse(), PaymentApiError, FaqItem (+9 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (23): 1. Internal API (Backend Proxy), 2. Dịch vụ lưu trữ & xác thực (Supabase), code:json ({), CV Storage — Kho CV, Danh sách API Endpoints (cvFit), Edge Function (tùy chọn — Supabase), `GET /api/config`, Hệ thống Email (Resend) (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.14
Nodes (17): handler(), handler(), CachedUser, decodeJwtPayload(), getCachedUser(), getUserFromBearerToken(), setCachedUser(), userCache (+9 more)

### Community 21 - "Community 21"
Cohesion: 0.29
Nodes (13): Header(), formatPlanExpiryDate(), isProPlan(), isRecruiterPlan(), MAX_CAMPAIGN_CVS, MAX_CAMPAIGNS, MAX_SAVED_JD_BY_PLAN, AnalyticsQuota (+5 more)
...
Cohesion: 0.2
Nodes (19): PaymentHandlerResult, convertObjToQueryStr(), createPaymentRequestSignature(), createPayosPaymentLink(), createSignatureFromObject(), fetchPaymentRequestInfo(), generateOrderCode(), getAppBaseUrl() (+11 more)
...
Cohesion: 0.24
Nodes (15): handler(), activateProForOrder(), fetchProfileForEmail(), handlePaymentConfirm(), handlePaymentCreate(), handlePaymentWebhook(), isWebhookPaymentSuccess(), normalizeOrderCode() (+7 more)
...
Cohesion: 0.21
Nodes (16): buildSchemaGraph(), escapeHtml(), FAQ_EN, FAQ_VI, HOWTO_STEPS_EN, HOWTO_STEPS_VI, Lang, main() (+8 more)
...
Cohesion: 0.33
Nodes (12): AdminReportStats, AnalysisLogRow, DailyAnalysisCount, dayKey(), fetchAllRows(), getAdminReportStats(), getCalendarMonthStart(), getRangeStart() (+4 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (12): AMP, escapeHtml(), action, body, resendClient, router, safeContent, safeTitle (+4 more)

### Community 34 - "Community 34"
Cohesion: 0.18
Nodes (10): handler(), isPdfBuffer(), PDF_HEADER, handleExtractPdf(), HandlerResult, isPdfBuffer(), PDF_HEADER, buffer (+2 more)

### Community 35 - "Community 35"
Cohesion: 0.3
Nodes (10): handleFeedback(), handler(), handleWelcome(), verifyRecaptcha(), HandlerResult, handleSendFeedback(), handleSendWelcomeEmail(), escapeHtml() (+2 more)
...
Cohesion: 0.17
Nodes (10): 1. Luồng phân tích đồng thời (Batch Analysis Flow), 2. Luồng tối ưu hóa & Xuất bản, 4. Luồng thanh toán Pro (PayOS Flow), 5. Quản lý dữ liệu, Các bước trọng tâm:, code:mermaid (graph TD), code:mermaid (graph TD), Gia hạn cộng dồn (nhiều lần mua Pro) (+2 more)
...
Cohesion: 0.18
Nodes (11): code:block12 (script-src 'self' 'unsafe-inline' 'unsafe-eval' ...), code:typescript (// api/extract-pdf.ts — no auth check), code:typescript (app.use(express.json({ limit: '50mb' }));       // ← TOO LAR), code:typescript (app.use(express.json({ limit: '15mb' }));   // 15MB is enoug), Findings, 🟠 HIGH-02: No Authentication on PDF Extraction Endpoint, 🟠 HIGH-03: Large Body Parser Limit (DoS Vector), 🔵 LOW-01: CSP Allows `unsafe-inline` and `unsafe-eval` (+3 more)
...
Cohesion: 0.36
Nodes (4): initSentry(), SCRUB_KEYS, scrubData(), startApp()

### Community 47 - "Community 47"
Cohesion: 0.29
Nodes (6): startServer(), apiLimiter, emailLimiter, staticLimiter, strictLimiter, router
...
Cohesion: 0.36
Nodes (6): SavedJdContext, useSavedJds(), deleteSavedJD(), getSavedJDs(), SavedJD, saveJDToProfile()

### Community 50 - "Community 50"
Cohesion: 0.33
Nodes (5): AnalysisDetailsTab, AnalysisDetailsTabProps, FormatAssessmentCard(), FormatAssessmentCardProps, getMatchingCategoryLabel()
...
Cohesion: 0.4
Nodes (4): { p_user_id, p_plan, p_duration_days }, { p_user_id, p_role }, router, supabase
...
## Knowledge Gaps
- **472 isolated node(s):** `SCRUB_KEYS`, `env`, `SCRUB_KEYS`, `ValidationError`, `AMP` (+467 more)
...
- **Why does `useUI()` connect `Community 5` to `Community 32`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 11`, `Community 12`, `Community 15`, `Community 49`, `Community 18`, `Community 17`, `Community 50`, `Community 21`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 32`, `Community 3`, `Community 4`, `Community 5`, `Community 11`, `Community 12`, `Community 18`, `Community 50`, `Community 21`, `Community 24`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `getUserFromBearerToken()` connect `Community 20` to `Community 0`, `Community 34`, `Community 14`, `Community 23`, `Community 25`, `Community 62`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **What connects `SCRUB_KEYS`, `env`, `SCRUB_KEYS` to the rest of the system?**
